        ...
        <>
            ...
            <div className="container-fluid row mt-5">
                ...
                <div className="col-md-6 p-3">
                    ...
                    <p className="">La ubicación oportuna en san andres cholula hace de este alojamiento una opción perfecta para viajeros y familias que buscan buena movilidad por toda la ciudad. </p>
                </div>
