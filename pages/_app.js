...
function MyApp({ Component, pageProps }) {
  ...
  const goAirbnb =() => {
    window.location.replace('https://www.airbnb.mx/rooms/45987082?check_in=2021-02-28&check_out=2021-03-07&previous_page_section_name=1000&federated_search_id=52778db7-a27e-4f24-8b71-a314bc73a99f&guests=1&adults=1');
  }
  const goBooking =() => {
    window.location.replace('https://www.booking.com/hotel/mx/loft-moderno-en-la-mejor-zona-de-cholula.es-mx.html');
  }
